    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                <a class="nav-item nav-link active" href="download.php">Download</a>
...
<div id="cow" style="margin: 15px">
    <button class="btn btn-outline-success my-2 my-sm-0" id="btnCow" onclick="buy()"  download="proposed_file_name">Download</button>
</div>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js" integrity="sha512-894YE6QWD5I59HgZOGReFYm4dnWc1Qt5NtvYSaNcOP+u1T9qYdvdihz0PPSiiqn/+/3e7Jo4EaG7TubfWGUrMQ==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
<script src="src/assets/userAccess.js"></script>
<?php if(isset($_SESSION['auth'])){?>
    <script src="src/assets/download.js"></script>
<?php }?>
